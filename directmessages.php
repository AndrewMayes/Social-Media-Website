<?php
	...
	$postFeed = "SELECT img, username, msg, post_time, msg_id from users inner join direct_messages on users.id = direct_messages.userid1 WHERE (userid1 = $userID AND userid2 = $uID) OR (userid1 = $uID AND userid2 = $userID) ORDER BY msg_id DESC LIMIT ".$pageFirstResult.",".$numPerPage."";
